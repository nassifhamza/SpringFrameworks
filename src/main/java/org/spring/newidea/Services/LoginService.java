...
import org.spring.newidea.Model.CREDENTIALS;
import org.spring.newidea.Model.User;
import org.spring.newidea.Model.userDto;
import org.spring.newidea.Repositary.Userrepo;
import org.spring.newidea.SecureApp.JWTSERVICE;
...
//    }
    ...
    public ResponseEntity<String> save(User user) {
        if (!userRepo.existsByUsername(user.getUsername()) && !userRepo.existsByEmail(user.getEmail())) {
            ...
            return ResponseEntity.ok("ACCOUNTED HAS BEEN CREATED !"); // Success
